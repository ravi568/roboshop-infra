...
module "rds"{
  source = "git::https://github.com/ravi568/tf-module-rds.git"
  env = var.env
  tags = var.tags
...
module "elasticache"{
  source = "git::https://github.com/ravi568/tf-module-elasticache.git"
  env = var.env
  tags = var.tags
...
module "minikube" {
  ...
  hosted_zone         = "kalluriravidevops71.online"
